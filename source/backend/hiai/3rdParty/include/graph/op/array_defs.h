 ...
 */
REG_OP(NetOutput)
.DYNAMIC_INPUT(x, TensorType({ DT_FLOAT, DT_INT8, DT_UINT8, DT_INT32 }))
.DYNAMIC_OUTPUT(y, TensorType({ DT_FLOAT, DT_UINT8, DT_INT8, DT_INT32, DT_FLOAT16 }))
.ATTR(output_type, AttrValue::LIST_INT ({}))
.OP_END()
