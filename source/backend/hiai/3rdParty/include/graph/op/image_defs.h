 ...
 *    para.cropSizeW = 240;
 *    para.cropSizeH = 240;
 *    hiai::op::ConfigData cropConfig = hiai::CreateConfigData(para, "cropConfig", hiai::op::ImageCropV2::TYPE);
 */
REG_OP(ConfigData)
.INPUT(x, TensorType({ DT_UINT8 }))
.OUTPUT(y, TensorType({ DT_UINT8 }))
 ...
 *
 *    static
 *    hiai::op::Const cropConst = hiai::CreateConfigConst(crop, "cropConst", hiai::op::ImageCropV2::TYPE);
 ...
 *
 *    static
 *    hiai::op::Const resizeConst = hiai::CreateConfigConst(resize, "resizeConst", hiai::op::ImageResizeV2::TYPE);
 ...
 *          hiai::CreateConfigConst(channelSwap, "swapConst", hiai::op::ImageChannelSwapV2::TYPE);
 ...
 *          hiai::CreateConfigData(channelSwap, "swapConfig", hiai::op::ImageChannelSwapV2::TYPE);
 *    auto channelSwapV2 = hiai::op::ImageChannelSwapV2("channelSwapV2")
 *                       .set_input_x(x)
 ...
 *         hiai::CreateConfigConst(cscPara, "cscConst", hiai::op::ImageColorSpaceConvertionV2::TYPE);
 ...
 *
 *    static
 *    hiai::op::Const dtcConst =
 *          hiai::CreateConfigConst(dtcPara, "dtcConst", hiai::op::ImageDataTypeConvertionV2::TYPE);
 ...
 *
 *    static
 *    hiai::op::Const rotateConst = hiai::CreateConfigConst(rotatePara, "rotateConst", hiai::op::ImageRotateV2::TYPE);
 ...
 *
 *    static
 *    hiai::op::Const padConst = hiai::CreateConfigConst(padPara, "padConst", hiai::op::ImagePadV2::TYPE);
